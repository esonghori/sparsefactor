...
int main(int argc, char*argv[])
{
	...
	if(argc!=11)
	{
		if(!myrank)
		{
			cout << "usage: mpiexec -n npes ./ataDVxS inDfile inVfile_prefix m n l numoffiles localD steps verbose ncpu" << endl;
			cout << "numoffiles % npes = 0" << endl;
			cout << "inVfile_prefix: inVfile_prefix_0 .. inVfile_prefix_{numoffiles-1}" << endl;
