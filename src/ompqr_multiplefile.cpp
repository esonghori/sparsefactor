...
int main(int argc, char*argv[])
{
	...
	{
		if(!myrank)
			cout << "usage: mpiexec -n npes ./ompqr infile_prefix outfile m n lmin lstep lmax kperl epsilon ncpu of mode verbos N" << endl;
	...
	unsigned int *idx_read = new unsigned int[myN];	
	if(!myrank)
	{
		randperm(n, idx);
	}
